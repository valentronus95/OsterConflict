...
# Pass45 must no longer pretend every weapon is just semi/auto. The source model now carries an explicit
# mechanical action family and a non-default burst selector capability that can be wired into server firing next.
for needle in (
...
print("- weapon tuning now separates mechanical action from broad weapon class")
print("- current implemented variants declare gas/delayed-blowback/blowback/short-recoil/bolt/pump/lever/belt/launcher truth")
print("- Burst3 exists as an explicit non-default capability; no current asset falsely claims it")
print("STATUS: SOURCE METADATA ONLY; server burst sequencing and manual-action presentation remain pending")
