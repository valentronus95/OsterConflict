...
checks = [
    ...
    ("approved main menu buttons stay narrow and restrained", "SetWidthOverride(420.0f)" in frontend_cpp and "0.08f" in frontend_cpp and "0.20f" in frontend_cpp and "0.28f" in frontend_cpp),
    ...
    ("pause presentation dims gameplay without main backdrop", "SetPresentationVisibility(true, false, true)" in frontend_cpp and "const ESlateVisibility ShadeVisibility = bDimGameplay" in frontend_cpp and "0.40f" in frontend_cpp),
