...
checks = [
    ...
    ("whole Oster uses dense real grass meshes", "SM_GrassPatch_Var01.SM_GrassPatch_Var01" in whole_oster_art and "constexpr float Fractions[] = { -0.42f, -0.21f, 0.0f, 0.21f, 0.42f }" in whole_oster_art and "GrassCount > 0" in whole_oster_art),
