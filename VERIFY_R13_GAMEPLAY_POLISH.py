...
checks = [
    ...
    ("dedicated frontend disables legacy panel hit testing", "LegacyFrontend->SetVisibility(ESlateVisibility::Collapsed)" in frontend_cpp and "LegacyFrontend->SetIsEnabled(false)" in frontend_cpp),
