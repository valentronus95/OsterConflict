...
void UOCR140SilpoPhotoModelSubsystem::BuildSilpo(UWorld& World)
{
    ...
    if (!Cube || !Basic)
    {
        UE_LOG(LogTemp, Error,
            TEXT("GAME_RECOVERY_SILPO_R140_PRELOAD_GAP cube=%d material=%d sync_load=0"),
            Cube ? 1 : 0, Basic ? 1 : 0);
        return;
    }
    ...
    UMaterialInstanceDynamic* Stucco = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_StuccoMat"), FLinearColor(0.72f, 0.57f, 0.42f, 1.0f));
    UMaterialInstanceDynamic* StuccoLight = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_StuccoLightMat"), FLinearColor(0.83f, 0.69f, 0.54f, 1.0f));
    UMaterialInstanceDynamic* FoundationMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_FoundationMat"), FLinearColor(0.28f, 0.29f, 0.28f, 1.0f));
    UMaterialInstanceDynamic* RoofMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_RoofMat"), FLinearColor(0.22f, 0.23f, 0.22f, 1.0f));
    UMaterialInstanceDynamic* GlassMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_GlassMat"), FLinearColor(0.14f, 0.20f, 0.22f, 1.0f));
    UMaterialInstanceDynamic* FrameMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_FrameMat"), FLinearColor(0.20f, 0.21f, 0.20f, 1.0f));
    UMaterialInstanceDynamic* SignOrange = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_SignOrangeMat"), FLinearColor(0.89f, 0.36f, 0.08f, 1.0f));
    UMaterialInstanceDynamic* SignBlue = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_SignBlueMat"), FLinearColor(0.05f, 0.29f, 0.43f, 1.0f));
    UMaterialInstanceDynamic* PromoBlue = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_PromoBlueMat"), FLinearColor(0.11f, 0.32f, 0.47f, 1.0f));
    UMaterialInstanceDynamic* PromoGreen = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_PromoGreenMat"), FLinearColor(0.30f, 0.45f, 0.20f, 1.0f));
    UMaterialInstanceDynamic* PromoNeutral = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_PromoNeutralMat"), FLinearColor(0.65f, 0.58f, 0.48f, 1.0f));
    UMaterialInstanceDynamic* StoreFloorMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_StoreFloorMat"), FLinearColor(0.66f, 0.66f, 0.62f, 1.0f));
    UMaterialInstanceDynamic* AsphaltMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_AsphaltMat"), FLinearColor(0.16f, 0.16f, 0.16f, 1.0f));
    UMaterialInstanceDynamic* ParkingMarkMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_ParkingMarkMat"), FLinearColor(0.74f, 0.73f, 0.66f, 1.0f));
    UMaterialInstanceDynamic* PlantMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_PlantStripMat"), FLinearColor(0.18f, 0.32f, 0.12f, 1.0f));
    UMaterialInstanceDynamic* FixtureMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_FixtureMat"), FLinearColor(0.90f, 0.90f, 0.84f, 1.0f));
    UMaterialInstanceDynamic* ShelfMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_ShelfMat"), FLinearColor(0.47f, 0.48f, 0.45f, 1.0f));
    UMaterialInstanceDynamic* CheckoutMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_CheckoutMat"), FLinearColor(0.29f, 0.30f, 0.28f, 1.0f));
    UMaterialInstanceDynamic* CoolerMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_CoolerMat"), FLinearColor(0.60f, 0.63f, 0.63f, 1.0f));
    UMaterialInstanceDynamic* ProduceMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_ProduceMat"), FLinearColor(0.43f, 0.37f, 0.25f, 1.0f));
    UMaterialInstanceDynamic* UtilityMat = MakeColorMaterial(Model, Basic, TEXT("R140Silpo_UtilityMat"), FLinearColor(0.19f, 0.20f, 0.19f, 1.0f));

    UInstancedStaticMeshComponent* Walls = MakeISM(Model, Root, Cube, Stucco, TEXT("R140Silpo_Walls"), true, true);
    UInstancedStaticMeshComponent* Parapet = MakeISM(Model, Root, Cube, StuccoLight, TEXT("R140Silpo_SteppedParapet"), true, true);
    UInstancedStaticMeshComponent* EntranceShell = MakeISM(Model, Root, Cube, StuccoLight, TEXT("R140Silpo_EntranceShell"), true, true);
    UInstancedStaticMeshComponent* Foundation = MakeISM(Model, Root, Cube, FoundationMat, TEXT("R140Silpo_Foundation"), true, false);
    UInstancedStaticMeshComponent* Roof = MakeISM(Model, Root, Cube, RoofMat, TEXT("R140Silpo_Roof"), true, true);
    UInstancedStaticMeshComponent* Windows = MakeISM(Model, Root, Cube, GlassMat, TEXT("R140Silpo_Windows"), false, false);
    UInstancedStaticMeshComponent* Frames = MakeISM(Model, Root, Cube, FrameMat, TEXT("R140Silpo_Frames"), false, true);
    UInstancedStaticMeshComponent* SignBack = MakeISM(Model, Root, Cube, SignOrange, TEXT("R140Silpo_FacadeSignBack"), false, true);
    UInstancedStaticMeshComponent* SignAccent = MakeISM(Model, Root, Cube, SignBlue, TEXT("R140Silpo_FacadeSignAccent"), false, true);
    UInstancedStaticMeshComponent* PromoA = MakeISM(Model, Root, Cube, PromoBlue, TEXT("R140Silpo_PromoBlue"), false, false);
    UInstancedStaticMeshComponent* PromoB = MakeISM(Model, Root, Cube, PromoGreen, TEXT("R140Silpo_PromoGreen"), false, false);
    UInstancedStaticMeshComponent* PromoC = MakeISM(Model, Root, Cube, PromoNeutral, TEXT("R140Silpo_PromoNeutral"), false, false);
    UInstancedStaticMeshComponent* StoreFloor = MakeISM(Model, Root, Cube, StoreFloorMat, TEXT("R140Silpo_StoreFloor"), true, false);
    UInstancedStaticMeshComponent* Asphalt = MakeISM(Model, Root, Cube, AsphaltMat, TEXT("R140Silpo_ForecourtAsphalt"), true, false);
    UInstancedStaticMeshComponent* ParkingMarks = MakeISM(Model, Root, Cube, ParkingMarkMat, TEXT("R140Silpo_ParkingMarks"), false, false);
    UInstancedStaticMeshComponent* PlantStrip = MakeISM(Model, Root, Cube, PlantMat, TEXT("R140Silpo_FacadePlantStrip"), false, false);
    UInstancedStaticMeshComponent* CeilingFixtures = MakeISM(Model, Root, Cube, FixtureMat, TEXT("R140Silpo_CeilingFixtures"), false, false);
    UInstancedStaticMeshComponent* Shelves = MakeISM(Model, Root, Cube, ShelfMat, TEXT("R140Silpo_EmptyShelves"), true, true);
    UInstancedStaticMeshComponent* Checkouts = MakeISM(Model, Root, Cube, CheckoutMat, TEXT("R140Silpo_Checkouts"), true, true);
    UInstancedStaticMeshComponent* Coolers = MakeISM(Model, Root, Cube, CoolerMat, TEXT("R140Silpo_WallCoolers"), true, true);
    UInstancedStaticMeshComponent* Produce = MakeISM(Model, Root, Cube, ProduceMat, TEXT("R140Silpo_EmptyProduceIsland"), true, true);
    UInstancedStaticMeshComponent* Utilities = MakeISM(Model, Root, Cube, UtilityMat, TEXT("R140Silpo_Utilities"), true, true);

    AddLocalBox(StoreFloor, Site, FVector(0.0f, 0.0f, 7.0f), FVector(BuildingLengthCm, BuildingDepthCm, 14.0f));
    AddLocalBox(Roof, Site, FVector(0.0f, 0.0f, WallHeightCm + 8.0f), FVector(BuildingLengthCm + 30.0f, BuildingDepthCm + 30.0f, 18.0f));

    const float WallZ = WallHeightCm * 0.5f;
    AddLocalBox(Walls, Site, FVector(0.0f, RearY, WallZ), FVector(BuildingLengthCm, WallThicknessCm, WallHeightCm));
    AddLocalBox(Walls, Site, FVector(-HalfLength, 0.0f, WallZ), FVector(WallThicknessCm, BuildingDepthCm, WallHeightCm));
    AddLocalBox(Walls, Site, FVector(HalfLength, 0.0f, WallZ), FVector(WallThicknessCm, BuildingDepthCm, WallHeightCm));
    ...
    if (LeftSegmentWidth > 1.0f)
        AddLocalBox(Walls, Site, FVector(-HalfLength + LeftSegmentWidth * 0.5f, FrontY, WallZ), FVector(LeftSegmentWidth, WallThicknessCm, WallHeightCm));
    if (RightSegmentWidth > 1.0f)
        AddLocalBox(Walls, Site, FVector(EntranceRight + RightSegmentWidth * 0.5f, FrontY, WallZ), FVector(RightSegmentWidth, WallThicknessCm, WallHeightCm));
    AddLocalBox(Walls, Site, FVector(EntranceCenterX, FrontY, EntranceHeightCm + (WallHeightCm - EntranceHeightCm) * 0.5f), FVector(EntranceWidthCm, WallThicknessCm, WallHeightCm - EntranceHeightCm));

    AddLocalBox(Foundation, Site, FVector(70.0f, FrontY - 15.0f, 26.0f), FVector(2700.0f, 20.0f, 52.0f));
    ...
    AddLocalBox(EntranceShell, Site, FVector(EntranceCenterX, FrontY - 18.0f, 306.0f), FVector(210.0f, 36.0f, 42.0f));
    AddLocalBox(Roof, Site, FVector(EntranceCenterX, FrontY - 155.0f, 302.0f), FVector(300.0f, 300.0f, 18.0f));
    AddLocalBox(Foundation, Site, FVector(EntranceCenterX, FrontY - 72.0f, 10.0f), FVector(250.0f, 135.0f, 20.0f));
    AddLocalBox(Foundation, Site, FVector(EntranceCenterX, FrontY - 145.0f, 5.0f), FVector(290.0f, 85.0f, 10.0f));

    struct FPromoSlot { float X; float Width; int32 Style; };
    const FPromoSlot PromoSlots[] = {
        { -980.0f, 300.0f, 0 }, { -610.0f, 310.0f, 1 }, { -230.0f, 300.0f, 2 },
        { 260.0f, 360.0f, 0 }, { 760.0f, 400.0f, 1 },
    };
    for (const FPromoSlot& Slot : PromoSlots)
    {
        UInstancedStaticMeshComponent* Target = Slot.Style == 0 ? PromoA : (Slot.Style == 1 ? PromoB : PromoC);
        AddLocalBox(Target, Site, FVector(Slot.X, FrontY - 23.0f, 175.0f), FVector(Slot.Width, 12.0f, 210.0f));
        AddLocalBox(Frames, Site, FVector(Slot.X, FrontY - 18.0f, 175.0f), FVector(Slot.Width + 18.0f, 10.0f, 228.0f));
    }
    ...
    for (int32 Row = -1; Row <= 1; ++Row)
    {
        ...
        {
            const FVector LocalLightLocation(static_cast<float>(Col) * 500.0f, static_cast<float>(Row) * 430.0f, 345.0f);
    ...
    if (World.GetNetMode() != NM_Client)
    {
        ...
        const FVector Hinge = At(Site, FVector(EntranceCenterX - EntranceWidthCm * 0.5f, FrontY - 10.0f, 10.0f));
        if (AOCInteractableDoor* Door = World.SpawnActor<AOCInteractableDoor>(AOCInteractableDoor::StaticClass(), Hinge, DoorRotation, SpawnParams))
        {
    ...
    UE_LOG(LogTemp, Display,
        TEXT("R14.0 Silpo photo model built at WGS84 %.9f, %.9f -> local [%.0f %.0f], stepped facade + left entrance + sparse interior. sync_load=0 prerequisite_resident=1"),
