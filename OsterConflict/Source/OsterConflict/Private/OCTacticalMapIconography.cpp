...
void UOCTacticalMapWidget::InstallTacticalIconography()
{
    ...
    // Legend: replace debug glyphs with one consistent, tintable vector icon family.
    ...
    // Footer: compact input prompts. Keep the controls textual enough to be unambiguous,
    // but let the icon communicate the action before the player has to read the label.
