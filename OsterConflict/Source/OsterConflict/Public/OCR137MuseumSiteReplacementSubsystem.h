 ...
 * museum proxy, old museum-only presentation layers, perimeter fences and competing vegetation
 * inside the museum site footprint. It is intentionally scoped to MuseumAnchor and does not touch
 * the adjacent stadium rebuild.
 */
UCLASS()
