...
try:
    ...
    print("ALL SOURCE + R13 OSTER PROP ART + R13 STEIN WEAPONS + R13 GAMEPLAY POLISH + R13 PC HARDENING + R11 VISUAL + R10 CXX + R9 UHT + R8 UE5.8 TARGET + R7 LOGIC/PHYSICS VERIFIERS: PASS")
finally:
