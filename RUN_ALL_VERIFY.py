...
for verifier in [
    ...
    'VERIFY_PASS45_COMPLETION_AUDIT.py',
]:
    run_verifier(ROOT / verifier)

print('ALL SOURCE + PASS45 COMPLETION AUDIT + PASS45 RUNTIME RECOVERY + PASS44 RUNTIME MAP/SPAWN/FPS/ASSETS + PASS43 SLATE STARTUP + PASS42 PRODUCTION VEHICLE/RACK + PASS41 INPUT + PASS40 UI FRAME + PASS39 VISUAL/TICK + PASS38 RUNAWAY/HEAT + PASS37 MUSEUM/PALETTE RETIREMENT + PASS36 WEAPON/PERF + LEGACY STRUCTURAL VERIFIERS: PASS')
