...
try:
    ...
    for name in [
        ...
        "VERIFY_R13_LOCATION_FIRST_S01_VEGETATION_RUNTIME.py",
        "VERIFY_R13_LOCATION_FIRST_S01_ROAD_TOPOLOGY.py",
        "VERIFY_R13_LOCATION_FIRST_S01_PARK_NORTH_PATH.py",
        "VERIFY_R13_LOCATION_FIRST_S01_KRUSHELNYTSKA_REFERENCES.py",
        "VERIFY_R13_LOCATION_FIRST_S01_KRUSHELNYTSKA_GATES.py",
        "VERIFY_R13_LOCATION_FIRST_S01_KRUSHELNYTSKA_GEOMETRY_FETCH.py",
