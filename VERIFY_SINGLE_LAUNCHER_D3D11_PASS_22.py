...
# START_HERE is the only user-facing launcher and exposes only normal play, full test and editor.
for needle in (
    "1. ЗВИЧАЙНА ГРА",
...
# Full test remains the Pass 21 wrapper, which itself chains the focused recovery launcher.
...
print("- normal game and full runtime acceptance use DirectX 11 after the reproduced D3D12RHI startup crash")
