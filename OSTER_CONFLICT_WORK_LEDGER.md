...
| TACTICAL-MAP-SOURCE-001 | `M` map, runtime guard `V` trap | CODED_UNTESTED / CLEANUP OPEN | `a6d31480...`, `d9d36c1...`, build fix `bb7d49b5...`; tactical subsystem remap guard є, constructor/HUD consistency ще треба дочистити. |
