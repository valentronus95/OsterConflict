...
for needle in (
    ...
    'class_counts.get("SkeletalMesh", 0)',
    'class_counts.get("AnimSequence", 0)',
...
print("PASS45 REMINGTON870 UE58 IMPORT PILOT: PASS static_contract=1 ue58_execution_pending=1 production_cutover=0 runtime_acceptance=0 item16_checked=0")
