...
if not "%M2_RC%"=="0" (
  echo [M2 IMPORT WARN] Production M2 import returned exit code %M2_RC%.
  echo Runtime will keep the existing real-machinegun diagnostic fallback for this run.
  exit /b %M2_RC%
)

echo [M2 IMPORT] Canonical M2 production asset import completed.
exit /b 0
